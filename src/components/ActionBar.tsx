...
export function ActionBar() {
  ...
  return (
    <>
      <div className="fixed bottom-0 left-0 lg:left-72 right-0 lg:right-80 bg-surface border-t border-white/10 p-3 lg:p-4 z-40 flex flex-col gap-2 lg:gap-3 animate-slide-up">
        {/* Warnings */}
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <div className={`text-xl font-mono font-bold ${
                carbsPerHour >= 60 && carbsPerHour <= 90 ? 'text-neon-green' :
                carbsPerHour > 90 ? 'text-red-400' : 'text-neon-blue'
              }`}>
                {carbsPerHour}g
              </div>
            </div>
            ...
            {planValidation && (
              <div>
                ...
                <div className={`text-xl font-mono font-bold flex items-center gap-1 ${
                  planValidation.score >= 80 ? 'text-neon-green' :
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={undo}
              disabled={!canUndo}
              className="p-2.5 bg-white/5 hover:bg-white/10 border border-white/10 text-white disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
              title="Undo (Ctrl+Z)"
            >
            ...
            <button
              ...
              className="px-6 py-2.5 bg-neon-orange hover:bg-white text-black font-bold uppercase text-sm tracking-wider flex items-center gap-2 transition-colors disabled:opacity-30 disabled:cursor-not-allowed hover:text-neon-orange"
            >
