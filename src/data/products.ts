...
export const products: ProductProps[] = [
  ...
  // Clif
  {
    ...
    color: 'green',
    priceZAR: 55.00,
    image: 'https://www.clifbar.com/cdn/shop/files/CLIF_2024_BLOKS_Single_FOP_StrawberryUpdated.png?v=1741026587&width=400',
    category: 'chew',
  },
  {
    id: 'clif-bar-energy',
    ...
    color: 'green',
    priceZAR: 45.00,
    image: 'https://www.clifbar.com/cdn/shop/files/CLIF_2023_Bar_ChocolateChip_Wrapper.png?v=1724362416&width=400',
    category: 'bar',
  },
  ...
  // Tailwind Nutrition
  {
    ...
    color: 'green',
    priceZAR: 42.00,
    image: 'https://www.tailwindnutrition.com/cdn/shop/files/TW-stickpack-mandarinorange.png?v=1693418893&width=400',
    category: 'drink',
  },
  {
    id: 'tailwind-caffeinated',
    brand: 'Tailwind',
    name: 'Caffeinated Fuel',
    calories: 200,
    carbs: 50,
    sodium: 310,
    caffeine: 35,
    color: 'green',
    priceZAR: 45.00,
    image: 'https://www.tailwindnutrition.com/cdn/shop/files/TW-stickpack-colorado-cola.png?v=1693418893&width=400',
    category: 'drink',
  },
  ...
  // Precision Fuel & Hydration
  {
    ...
    color: 'red',
    priceZAR: 48.00,
    image: 'https://www.precisionfuelandhydration.com/cdn/shop/files/PF30-Gel-Vanilla-90g.png?v=1692783600&width=400',
    category: 'gel',
  },
  {
    id: 'pfh-sweat-1500',
    ...
    color: 'red',
    priceZAR: 195.00,
    image: 'https://www.precisionfuelandhydration.com/cdn/shop/files/PH-1500-Tube-of-12-2023.png?v=1692783600&width=400',
    category: 'drink',
  },

  // Spring Energy
  {
    id: 'spring-awesome-sauce',
    brand: 'Spring Energy',
    name: 'Awesome Sauce',
    calories: 200,
    carbs: 33,
    ...
    color: 'green',
    priceZAR: 95.00,
    image: 'https://springenergy.us/cdn/shop/files/awesome-sauce-front.png?v=1710520000&width=400',
    category: 'gel',
  },
  ...
  // Homemade / DIY options
  {
    ...
    color: 'red',
    priceZAR: 15.00,
    image: 'data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect fill="%23cc0000" width="100" height="100" rx="10"/><text x="50" y="55" text-anchor="middle" fill="white" font-size="11" font-weight="bold">COLA</text></svg>',
    category: 'drink',
  },
  {
    id: 'diy-rice-cakes',
    ...
    color: 'yellow',
    priceZAR: 10.00,
    image: 'data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect fill="%23d4a843" width="100" height="100" rx="10"/><text x="50" y="55" text-anchor="middle" fill="white" font-size="10" font-weight="bold">RICE</text></svg>',
    category: 'bar',
  },
  {
    id: 'diy-gummy-bears',
    brand: 'DIY',
    name: 'Gummy Bears (handful)',
    calories: 130,
    carbs: 30,
    sodium: 10,
    caffeine: 0,
    color: 'yellow',
    priceZAR: 8.00,
    image: 'data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect fill="%23e8a030" width="100" height="100" rx="10"/><text x="50" y="55" text-anchor="middle" fill="white" font-size="9" font-weight="bold">GUMMY</text></svg>',
    category: 'chew',
  },
];
